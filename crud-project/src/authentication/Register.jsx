    ...
    <>
      <section className='h-full w-full'>
        <form onSubmit={handleSubmit} className='h-fit w-[350px] bg-slate-800 text-gray-500 px-3 py-4 rounded-lg shadow-lg'>
          <h1 className='text-xl text-white text-center'>Registration Form</h1>
          <section className='mt-1 flex flex-col gap-3'>
            ...
            <div className='mt-3 w-full'>
              <button className='w-full py-1.5 text-center text-white text-sm bg-blue-700 hover:bg-blue-900 rounded-md'>Register now</button>
            </div>
          </section>
        </form>
      </section>
